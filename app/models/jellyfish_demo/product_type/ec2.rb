  ...
  module ProductType
    class Ec2 < ::ProductType
      def self.load_product_types
        ...
        transaction do
          [
            set('EC2 Instance', 'd16d5017-6d6b-4775-958f-535f68b4cf04', provider_type: 'JellyfishDemo::Provider::Demo')
          ].each do |s|
            create! s.merge!(type: 'JellyfishDemo::ProductType::Ec2')
          end
        end
      end
      ...
      def service_class
        'JellyfishDemo::Service::Ec2'.constantize
      end
    end
  end
end
