  ...
  module ProductType
    class RDS < ::ProductType
      def self.load_product_types
        ...
        transaction do
          [
            set('RDS Instance', 'fbd69f29-4150-4ea3-9ff1-90ae33f4a1f4', provider_type: 'JellyfishDemo::Provider::Demo')
          ].each do |s|
            create! s.merge!(type: 'JellyfishDemo::ProductType::RDS')
          end
        end
      end
      ...
      def service_class
        'JellyfishDemo::Service::RDS'.constantize
      end
    end
  end
end
